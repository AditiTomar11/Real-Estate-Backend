...
import com.bhoomi.realestate_backend.security.CustomUserDetailsService;
import com.bhoomi.realestate_backend.security.JwtAuthFilter;
...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity // activates @PreAuthorize("hasRole('ADMIN')") on controllers
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET,
                                "/api/trending-projects/**", "/api/featured-cities/**",
                                "/api/why-choose-us/**", "/api/how-it-works/**",
